...
<c:import url="..//common/base.jsp">
    ...
    <c:param name="content">
        <section class="me-4">
			...
			<input class="touroku" type="button" value="登録" style="background-color: #3399FF; color: white; border: none; border-radius: 5px; padding: 5px 10px; font-size: 15px"> <br><br>
			<a href="" >戻る</a>
        </section>
