    ...
    <c:param name="content">
        <section class="me-4">
			...
			<form class="" action="SubjectCreateExcecute.action" method="post">
				...
				<input type="text" name="cd" value="${cd}" placeholder="科目コードを入力してください" style="border-radius: 5px; width: 820px; height:37px; border: 1px solid #dee2e6;" required><br><br>
				<div style="color: #FFCC00;">${errorcd}</div>
				<div style="color: #FFCC00;">${errorlength}</div>
				<label>科目名</label><br>
				<input type="text" name="name" value="${name}" placeholder="科目名を入力してください" style="border-radius: 5px; width: 820px; height:37px; border: 1px solid #dee2e6;" required><br><br>
