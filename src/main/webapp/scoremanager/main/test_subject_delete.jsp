...
<c:import url="/scoremanager/main/common/base.jsp">
    ...
    <c:param name="content">
    	<section class="me-4">
		     ...
		     <form action="TestListSubjectDeleteExecute.action" method="post">
			      ...
			      <input type="hidden" name="ent_year" value="${tests.entYear}">
			      <input type="hidden" name="class_num" value="${tests.classNum}">
