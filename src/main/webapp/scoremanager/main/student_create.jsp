		...
		<section class="me-4">
            ...
            <form style="margin : 20px ;" method="get" action="StudentCreateExecute.action">
				...
				<div class="col-4">
                    ...
                    <input type="text" style="width:300%; padding: 7px 7px; border-radius: 5px;  border: 1px solid #ced4da;" placeholder="学生番号を入力してください" class="form-input" name="no"required>
                    <div style="color: #FFCC00;">${notaddd}</div>
                </div>
                
                <div class="col-4">
                    <label class="form-label">氏名</label>
                    <input type="text" style="width:300%; padding: 7px 7px; border-radius: 5px;  border: 1px solid #ced4da;" placeholder="氏名を入力してください" class="form-input" name="name" required>
                </div>  
